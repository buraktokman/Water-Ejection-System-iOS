...
export const addNotifySchedule = (title, message, time, repeatType) => {
  ...
  PushNotification.localNotificationSchedule({
    ...
    date: time,
    playSound: true,
    soundName: 'Success_2.m4a', // 'default',
  });
  // PushNotificationIOS.getScheduledLocalNotifications((callback) => {
  //   // console.log(callback);
  //   callback.map((val) => {
...
// --------- ADD NOTIF NOW  --------------
export const addNow = (title, message, soundName) => {
  ...
  PushNotification.localNotificationSchedule({
    ...
    playSound: soundName === false ? false : true,
    soundName: soundName !== 'undefined' ? 'Success_2.m4a' : 'default', // 'default',
  });
